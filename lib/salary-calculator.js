...
export class SalaryCalculator {
  ...
  calculateStandard(grossSalary, options = {}) {
    ...
    return {
      ...
      totalDeductions,
      taxableIncome,
      taxableGross, // Baza impozabilă după scăderea sumei netaxabile
      untaxedAmount, // Suma netaxabilă aplicată
      cam,
      totalCost,
      voucherValue,
      // Breakdown pentru UI
  ...
  calculateIT(grossSalary, options = {}) {
    ...
    if (taxableGross <= threshold) {
      ...
      const taxableAmount = taxableGross - threshold;
