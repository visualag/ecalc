export const mapDbToFiscalRules = (dbData) => {
    ...
    // Handle Array (History of Rules)
    if (Array.isArray(dbData)) {
        return dbData.map(item => mapSingleRule(item));
    }

    // Handle Single Object (Legacy/Fallback)
    return mapSingleRule(dbData);
};

const mapSingleRule = (dbData) => {
    ...
    return {
        ...
        effectiveDate: dbData.effectiveDate || '2026-01-01', // Default to Jan 1st if missing
