...
export const generateSEOStory = (cityName, weather, currentYear) => {
    ...
    return (
        <div className="mt-4 bg-white border border-slate-200 rounded-[6px] shadow-sm overflow-hidden">
            <div className="p-3 border-b border-slate-100 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Meteo Profesional & Recomandări Tehnice • {currentYear}</p>
                    </div>
                </div>
            ...
            <div className="p-3 grid md:grid-cols-2 gap-8">
